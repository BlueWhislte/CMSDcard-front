...
export default function Home() {
  ...
  return (
    <Layout>
      <main>
        <div className="py-5 text-center text-white h-100 align-items-center d-flex" style={{backgroundImage: "url(blue.jpg)", backgroundPosition: "center", backgroundSize: "cover", backgroundRepeat: "repeat"}} samesite="None">
